pipeline {
  ...
  environment {
    NETLIFY_SITE_ID = '502af213-166a-415c-97d5-e1217de3267e'
  ...
  stages {
    ...
    stage('Deploy staging') {
      ...
      steps {
        sh '''
          npm install netlify-cli@21.6.0 node-jq@6.0.1
    ...
    stage('Deploy prod') {
      ...
      environment {
        CI_ENVIRONMENT_URL = 'https://dainty-pony-9c7ebf.netlify.app'
      }
